...
Patterns such as `Rc<RefCell<T>>` are highly discouraged. This is a very easy way to enter the dreaded "type hell." Only do this if you are in a frontend and are practically forced to do this, and you have no other options (like message passing, for example).
